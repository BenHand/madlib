...
OriginalQuote.create(author: "Abraham Lincoln",
                ...
                input_quote: "Don’t believe everything you read on the internet.")
OriginalQuote.create(author: "Joseph Nash",
                      quote: "There is no shred of evidence in favor of the idea that life is serious.",
                input_quote: "There is no shred of evidence in favor of the idea that life is serious.")
OriginalQuote.create(author: "Isaac Asimov",
                      quote: "Life is pleasant. Death is peaceful. It's the transition that's troublesome.",
                input_quote: "Life is pleasant. Death is peaceful. It's the transition that's troublesome.")
OriginalQuote.create(author: "Isaac Asimov",
                      quote: "If knowledge can create problems, it is not through ignorance that we can solve them.",
                input_quote: "If knowledge can create problems, it is not through ignorance that we can solve them.")
OriginalQuote.create(author: "Barack Obama",
                      quote: "If you're walking down the right path and you're willing to keep walking, eventually you'll make progress.",
                input_quote: "If you're walking down the right path and you're willing to keep walking, eventually you'll make progress.")
OriginalQuote.create(author: "Barack Obama",
                      quote: "That's the good thing about being president, I can do whatever I want.",
                input_quote: "That's the good thing about being president, I can do whatever I want.")
OriginalQuote.create(author: "Michael Jackson",
                      quote: "I'm just like anyone. I cut and I bleed. And I embarass easily.",
                input_quote: "I'm just like anyone. I cut and I bleed. And I embarass easily.")
OriginalQuote.create(author: "Sun Tzu",
                ...
                input_quote: "If you know the enemy and know yourself you need not fear the results of a hundred battles.")
OriginalQuote.create(author: "Sun Tzu",
                      quote: "The supreme art of war is to subdue the enemy without fighting.",
                input_quote: "The supreme art of war is to subdue the enemy without fighting.")
OriginalQuote.create(author: "E.A. Poe",
                      quote: "Once upon a midnight dreary, while I pondered weak and weary.",
                input_quote: "Once upon a midnight dreary, while I pondered weak and weary.")
